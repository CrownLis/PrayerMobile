...
import MyDeskIcon from '~assets/icons/my-desk.svg';
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <View style={styles.navigation}>
              <MyDeskIcon width={24} height={24} fill={focused ? '#2A2A2A' : '#CFCFCF'} />
              <Text>My Desk</Text>
            </View>
          ),
        }}
